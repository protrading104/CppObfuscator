...
- `main() -> Result<(), Box<dyn Error>>` — точка входа: анти‑отладка, обход EDR, расшифровка и исполнение PE в памяти.
...
### `amsi.rs`
- `patch_amsi() -> bool` — патчит `AmsiScanBuffer`, возвращая `false`.
